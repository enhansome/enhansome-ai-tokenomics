...
* [CodexBar](https://github.com/steipete/CodexBar) ⭐ 20,338 | 🐛 109 | 🌐 Swift | 📅 2026-08-19 - A free, open-source macOS menu-bar app that shows limits and reset timers at a glance across dozens of AI providers, plus credit balances and spending. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/steipete/CodexBar?style=flat-square\&label=)
* [ccusage](https://github.com/ccusage/ccusage) ⭐ 18,037 | 🐛 29 | 🌐 Rust | 📅 2026-08-19 - An open-source CLI that reads local agent logs to report token usage and cost across 15 coding-agent sources, with caching-aware pricing. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/ccusage/ccusage?style=flat-square\&label=)
* [CodeBurn](https://github.com/getagentseal/codeburn#find-and-fix-waste) ⭐ 9,540 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-18 - An open-source tracker for 36 coding tools whose optimize command flags named harness-waste patterns with dollar estimates it later checks against actuals. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square)
* [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,642 | 🐛 36 | 🌐 Python | 📅 2026-07-05 - A live terminal dashboard for Claude Code usage, with burn-rate analytics, P90 limit detection, and session-expiry forecasts. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/Maciek-roboblog/Claude-Code-Usage-Monitor?style=flat-square\&label=)
* [gh-aw (GitHub Agentic Workflows)](https://github.com/github/gh-aw) ⭐ 4,958 | 🐛 420 | 🌐 Go | 📅 2026-08-19 - GitHub's agentic-workflows runtime with first-party per-run token and cost metering, plus budget caps that stop a workflow mid-run. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/github/gh-aw?style=flat-square\&label=)
* [OpenUsage](https://github.com/robinebers/openusage) ⭐ 3,824 | 🐛 47 | 🌐 Swift | 📅 2026-08-19 - A native Swift macOS menu-bar meter for 10 AI coding subscriptions, showing session and weekly limits, credits, and estimated spend from local credentials. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/robinebers/openusage?style=flat-square\&label=)
...
* [OpenLLMetry](https://github.com/traceloop/openllmetry) ⭐ 7,385 | 🐛 646 | 🌐 Python | 📅 2026-08-10 - An open-source set of OpenTelemetry-based SDKs and instrumentations, built by Traceloop, for LLM apps. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/traceloop/openllmetry?style=flat-square\&label=)
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,481 | 🐛 212 | 🌐 Python | 📅 2026-08-19 - Comet's open-source (Apache-2.0) LLM observability platform, with per-span USD cost estimated from token usage. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/comet-ml/opik?style=flat-square\&label=)
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,112 | 🐛 950 | 🌐 Python | 📅 2026-08-19 - A source-available (Elastic License 2.0) LLM tracing platform recording per-span token counts and USD cost via OpenTelemetry. ![tool: Elastic-2.0](https://img.shields.io/badge/tool-Elastic--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/Arize-ai/phoenix?style=flat-square\&label=)
...
* [LMCache](https://github.com/LMCache/LMCache) ⭐ 11,215 | 🐛 548 | 🌐 Python | 📅 2026-08-19 - A self-hosted KV-cache layer beneath vLLM, giving token-level cache-hit observability for teams who own their GPUs, not a hosted bill. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/LMCache/LMCache?style=flat-square\&label=)
...
* [Codex CLI compaction cost - over-eager compaction as a token-amplification loop](https://github.com/openai/codex/issues/16812) ⭐ 106,827 | 🐛 13,156 | 🌐 Rust | 📅 2026-08-19 - Upgrading Codex CLI from v0.116 to v0.118 made context compaction fire twice as often, doubling or tripling token consumption for identical tasks.
* [Serena](https://github.com/oraios/serena) ⭐ 28,240 | 🐛 111 | 🌐 Python | 📅 2026-08-18 - An open-source (MIT) MCP toolkit that gives a coding agent IDE-grade semantic code retrieval and editing: 'the IDE for your coding agent'. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/oraios/serena?style=flat-square\&label=)
* [Repomix](https://github.com/yamadashy/repomix) ⭐ 27,958 | 🐛 133 | 🌐 TypeScript | 📅 2026-08-18 - Packs an entire repository into a single AI-friendly file, reporting token counts and using Tree-sitter to compress code to signatures only. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/yamadashy/repomix?style=flat-square\&label=)
...
* [Harness-side runaway-loop cost guardrails (Claude Code + Codex, July 2026)](https://github.com/anthropics/claude-code/releases/tag/v2.1.212) ⭐ 141,996 | 🐛 15,162 | 🌐 Python | 📅 2026-08-18 - In mid-July 2026 Claude Code and Codex both shipped first-party guardrails against runaway agent loops within days of each other.

### Gateways and Proxies

* [LiteLLM](https://github.com/BerriAI/litellm) ⭐ 56,755 | 🐛 4,990 | 🌐 Python | 📅 2026-08-19 - An open-source gateway fronting 100+ LLM APIs that computes real per-request dollar cost from a live pricing map, with spend limits. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/BerriAI/litellm?style=flat-square\&label=)
* [Bifrost (Maxim AI)](https://github.com/maximhq/bifrost) ⭐ 7,431 | 🐛 896 | 🌐 Go | 📅 2026-08-19 - Bifrost is a Go-based AI gateway fronting 1,000+ models that measured just 11 microseconds of added latency per request at 5,000 requests per second. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/maximhq/bifrost?style=flat-square\&label=)
...
* [claude-mem](https://github.com/thedotmack/claude-mem) ⭐ 91,239 | 🐛 230 | 🌐 JavaScript | 📅 2026-08-19 - A coding-agent observational-memory layer that captures every session, compresses it with AI, and re-injects relevant context next time. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/thedotmack/claude-mem?style=flat-square\&label=)
* [Mem0](https://github.com/mem0ai/mem0) ⭐ 63,603 | 🐛 690 | 🌐 Python | 📅 2026-08-18 - An open-source memory layer that extracts salient facts from conversations and retrieves only the relevant ones per call, not the full history. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/mem0ai/mem0?style=flat-square\&label=)
* [Cognee](https://github.com/topoteretes/cognee) ⭐ 30,118 | 🐛 359 | 🌐 Python | 📅 2026-08-19 - An open-source (Apache-2.0) AI-memory platform giving agents persistent memory via a self-hosted knowledge graph, via remember/recall/forget. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/topoteretes/cognee?style=flat-square\&label=)
* [Zep / Graphiti](https://www.getzep.com/) - A memory platform for agents built on temporal knowledge graphs; it self-reports serving benchmark answers from a few thousand tokens of retrieved context. (also: [Graphiti (OSS engine)](https://github.com/getzep/graphiti) ⭐ 30,090 | 🐛 491 | 🌐 Python | 📅 2026-08-18 · [zep repo](https://github.com/getzep/zep) ⭐ 4,851 | 🐛 22 | 🌐 Python | 📅 2026-08-13) ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square)
* [Supermemory](https://github.com/supermemoryai/supermemory) ⭐ 28,957 | 🐛 176 | 🌐 TypeScript | 📅 2026-08-19 - A memory and context engine that self-reports 95% recall on LongMemEval while adding only \~720 tokens of context. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/supermemoryai/supermemory?style=flat-square\&label=)
* [Letta (MemGPT)](https://github.com/letta-ai/letta) ⭐ 24,303 | 🐛 41 | 📅 2026-08-16 - The MemGPT lineage project: a platform for stateful agents that pages an LLM's context like an OS. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/letta-ai/letta?style=flat-square\&label=)
* [LangMem](https://github.com/langchain-ai/langmem) ⭐ 1,619 | 🐛 61 | 🌐 Python | 📅 2026-08-11 - LangChain's long-term memory library: it extracts and consolidates facts from conversations and integrates natively with LangGraph's memory store. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/langchain-ai/langmem?style=flat-square\&label=)
* [claude-code-memory-setup](https://github.com/lucasrosati/claude-code-memory-setup) ⭐ 942 | 🐛 6 | 🌐 Python | 📅 2026-06-01 - A practitioner recipe pairing an Obsidian memory vault with a local AST code-graph tool. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/lucasrosati/claude-code-memory-setup?style=flat-square\&label=)
...
* [PageIndex](https://github.com/VectifyAI/PageIndex) ⭐ 35,249 | 🐛 158 | 🌐 Python | 📅 2026-08-19 - Vectorless RAG engine that builds a hierarchical tree index over long documents and has an LLM reason over the index instead of embedding chunks. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/VectifyAI/PageIndex?style=flat-square\&label=)
...
* [vLLM](https://github.com/vllm-project/vllm) ⭐ 89,452 | 🐛 6,792 | 🌐 Python | 📅 2026-08-19 - The canonical open-source LLM serving engine, using PagedAttention to manage KV-cache memory in blocks so more requests batch at lower cost. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/vllm-project/vllm?style=flat-square\&label=)
* [SGLang](https://github.com/sgl-project/sglang) ⭐ 32,110 | 🐛 4,916 | 🌐 Python | 📅 2026-08-19 - A high-performance serving framework for large language and multimodal models. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/sgl-project/sglang?style=flat-square\&label=)
...
* [OpenHands - MIT OSS coding agent, free local + free cloud tier, at-cost LLM option](https://github.com/OpenHands/OpenHands) ⭐ 84,484 | 🐛 490 | 🌐 TypeScript | 📅 2026-08-19 - An MIT-licensed open-source coding-agent platform with a free local mode, a free cloud tier, and an at-cost LLM pricing option. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/OpenHands/OpenHands?style=flat-square\&label=)
* [Cline - an OSS coding agent on a bring-your-own-key cost model](https://github.com/cline/cline) ⭐ 66,478 | 🐛 1,043 | 🌐 TypeScript | 📅 2026-08-19 - An open-source AI coding agent (Apache-2.0, \~65k★, \~4.8M VS Code installs), built on a bring-your-own-API-key cost model. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/cline/cline?style=flat-square\&label=)
* [Aider - an OSS coding CLI that meters its own dollar cost](https://github.com/Aider-AI/aider) ⭐ 48,326 | 🐛 1,818 | 🌐 Python | 📅 2026-05-22 - An open-source terminal coding agent (Apache-2.0, \~48k★) with built-in per-message dollar-cost tracking and a public polyglot leaderboard. ![tool: Apache-2.0](https://img.shields.io/badge/tool-Apache--2.0-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/Aider-AI/aider?style=flat-square\&label=)
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,377 | 🐛 509 | 🌐 TypeScript | 📅 2026-08-19 - An open-source CLI/CI harness for testing LLM prompts and agents that records per-eval token usage and cost as an assertable metric. ![tool: MIT](https://img.shields.io/badge/tool-MIT-blue?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/promptfoo/promptfoo?style=flat-square\&label=)
* [SWE-bench](https://github.com/SWE-bench/SWE-bench) ⭐ 5,668 | 🐛 8 | 🌐 Python | 📅 2026-08-18 - The canonical accuracy-only software-engineering benchmark (2,294 real GitHub issue tasks, 12 Python repos, ICLR 2024). The cost-aware derivatives in this list build on it. ![bench](https://img.shields.io/badge/bench-555?style=flat-square) ![last commit](https://img.shields.io/github/last-commit/SWE-bench/SWE-bench?style=flat-square\&label=)
...
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 92,567 | 🐛 3,196 | 📅 2026-08-17 - A collection of Model Context Protocol servers.
* [Awesome-LLM](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,272 | 🐛 437 | 📅 2025-07-31 - Curated papers, frameworks, and resources on large language models.
...
* [Awesome-LLMOps](https://github.com/tensorchord/Awesome-LLMOps) ⭐ 5,917 | 🐛 246 | 🌐 Shell | 📅 2026-05-21 - Tools and platforms for operating LLMs in production.
